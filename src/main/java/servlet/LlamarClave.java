 ...
 * @author ANGHELO
 */
@WebServlet(name = "LlamarClave", urlPatterns = {"/llamarClave"})
public class LlamarClave extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String usu = usuDAO.clave(usuario, claveMD5);
            String claveRecibidadC = MD5.getMd5Hash(usu);
            if (usu != null) {
